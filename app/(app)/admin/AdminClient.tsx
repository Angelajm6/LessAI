      ...
      <div className="grid grid-cols-3 gap-4">
        <Card className="border-0 bg-emerald-50">
          <CardContent className="pt-6">
            ...
            <div className="text-sm text-gray-600 mt-1 font-medium">Team members</div>
            <div className="text-xs text-gray-400 mt-0.5">Licensed seats</div>
          </CardContent>
        </Card>
        <Card className="border-0 bg-emerald-50">
          <CardContent className="pt-6">
            <div className="text-3xl font-bold text-emerald-600">{onboardedCount}</div>
            <div className="text-sm text-gray-600 mt-1 font-medium">Onboarded</div>
            <div className="text-xs text-gray-400 mt-0.5">Completed AI path setup</div>
          </CardContent>
        </Card>
        <Card className="border-0 bg-emerald-50">
          <CardContent className="pt-6">
            <div className="text-3xl font-bold text-emerald-600">{adoptionRate}%</div>
            <div className="text-sm text-gray-600 mt-1 font-medium">Adoption rate</div>
            <div className="text-xs text-gray-400 mt-0.5">Active vs. invited</div>
          </CardContent>
        </Card>
      </div>
